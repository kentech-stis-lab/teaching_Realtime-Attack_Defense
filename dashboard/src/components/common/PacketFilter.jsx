...
const FILTERS = {
  ...
  brute_ssh: {
    tshark: 'tshark -i any -V -Y "ip.src == 172.20.0.100 && tcp.dstport == 2222"',
    wireshark: 'ip.src == 172.20.0.100 && tcp.dstport == 2222',
    desc: 'SSH Brute Force - backend��SSH server (172.20.0.11:2222)',
    tip: 'SSH handshake + auth attempts',
    payload: false,
  },
  brute_ftp: {
  ...
  dos_slowloris: {
    tshark: 'tshark -i any -V -Y "ip.dst == 172.20.1.10 && tcp.dstport == 3000 && tcp.flags.syn == 1"',
    wireshark: 'ip.dst == 172.20.1.10 && tcp.dstport == 3000 && tcp.flags.syn == 1',
    desc: 'DoS Slowloris - backend→Juice Shop SYN flood',
    tip: 'many SYN connections to exhaust server resources',
    payload: false,
  },
  portscan: {
    tshark: 'tshark -i any -V -Y "ip.src == 172.20.1.100 && tcp.flags.syn == 1 && tcp.flags.ack == 0"',
    wireshark: 'ip.src == 172.20.1.100 && tcp.flags.syn == 1 && tcp.flags.ack == 0',
    desc: 'Port Scan - backend scanning multiple ports',
    tip: 'SYN packets to many destination ports',
    payload: false,
  },
  infiltration: {
